        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Country = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: false, defaultValue: "USA")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Skils = table.Column<string>(type: "nvarchar(2048)", maxLength: 2048, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EINumber = table.Column<string>(type: "nvarchar(9)", maxLength: 9, nullable: false),
                    PrimariPhone = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    PrimeryEmail = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Client_Address_CompanyAddressId",
                        column: x => x.CompanyAddressId,
                        principalTable: "Address",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Client_Address_MailAddressId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Protocol = table.Column<string>(type: "nvarchar(13)", maxLength: 13, nullable: false),
                    OpenDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ClosedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Status = table.Column<int>(type: "int", maxLength: 15, nullable: false),
                    ProblemDescription = table.Column<string>(type: "nvarchar(2048)", maxLength: 2048, nullable: false),
                    TechnicalSolution = table.Column<string>(type: "nvarchar(2048)", maxLength: 2048, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PartItem", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Client_CompanyAddressId",
                table: "Client",
                column: "CompanyAddressId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Client_MailAddressId",
                table: "Client",
