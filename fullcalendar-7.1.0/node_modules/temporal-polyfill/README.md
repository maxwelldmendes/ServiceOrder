...
```html
<script src='https://cdn.jsdelivr.net/npm/temporal-polyfill@1.0.5/global.min.js'></script>
<script>
...
```html
<script src='https://cdn.jsdelivr.net/npm/temporal-polyfill@1.0.5/full/global.min.js'></script>
<script>
