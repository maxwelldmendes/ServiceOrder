import { requireString, isoCalendarId, isoCalendarImpl, gregoryCalendarId, gregoryCalendarImpl, timeGetters, checkEpochNanoInBounds, toBigInt, queryTimeZone, refineTimeZoneId, compareZonedEpochSlots, getCalendarSlotId, epochNanoToMilli, formatOffsetNano, zonedEpochSlotsToIso, computeZonedHoursInDay, zonedDateTimeWithPlainTime, moveZonedEpochSlots, negateDurationFields, roundZonedEpochSlotsToUnit, computeZonedStartOfDay, zonedDateTimesEqual, zonedDateTimeToInstant, zonedDateTimeToDateTime, zonedDateTimeToDate, zonedDateTimeToTime, RawDateTimeFormat, applyZonedFormatTimeZone, getZonedTimeZoneId, transformZonedOptions, checkResolvedCalendarCompatible, formatZonedDateTimeIso, isObjectLike, refineZonedDateTimeObjectLike, parseZonedDateTime, createZonedEpochNanoSlots, throwTypeError, invalidTimeZone, resolveTimeZoneId, parseTimeZoneId, epochMilliToInstant, epochNanoToInstant, createEpochNanoSlots, moveEpochNano, roundBigNanoToDayOriginInc, computeBigNanoInc, instantsEqual, instantToZonedDateTime, transformInstantOptions, formatInstantIso, parseInstant, requireNumberIsInteger, bigNanoInMilli, isoEpochFirstLeapYear, checkIsoDateInBounds, validateIsoDateFields, createDateSlots, plainMonthDaysEqual, monthDayToDate, applyPlainFormatTimeZone, transformMonthDayOptions, isoDateToEpochMilli, formatPlainMonthDayIso, refinePlainMonthDayObjectLike, parsePlainMonthDay, checkIsoYearMonthInBounds, compareIsoDateFields, moveYearMonth, plainYearMonthsEqual, yearMonthToDate, transformYearMonthOptions, formatPlainYearMonthIso, refinePlainYearMonthObjectLike, parsePlainYearMonth, invalidBag, validateTimeFields, mapProps, compareTimeFields, moveTime, roundTimeToInc, plainTimesEqual, transformTimeOptions, timeFieldsToMilli, formatPlainTimeIso, createTimeSlots, refinePlainTimeObjectLike, parsePlainTime, computeNanoInc, checkIsoDateTimeInBounds, validateIsoDateTimeFields, createDateTimeSlots, compareIsoDateTimeFields, createDateTimeFromRefinedFields, moveDateTime, roundDateTimeToInc, plainDateTimesEqual, dateTimeToZonedDateTime, transformDateTimeOptions, isoDateTimeToEpochMilli, formatPlainDateTimeIso, combineDateAndTime, refinePlainDateTimeObjectLike, parsePlainDateTime, timeFieldDefaults, moveDate, plainDatesEqual, dateToZonedDateTime, fieldsToYearMonth, fieldsToMonthDay, transformDateOptions, formatPlainDateIso, refinePlainDateObjectLike, parsePlainDate, invalidCalendar, parseCalendarId, durationGetters, validateDurationFields, toStrictInteger, createDurationSlots, compareDurations, mergeDurationFields, negateDuration, absDuration, addDurationsWithoutRelativeTo, roundDuration, totalDuration, formatDurationIso, refineDurationObjectLike, parseDuration, refineMaybeZonedDateTimeObjectLike, parseRelativeToSlots, createStringTagDescriptors, createPropDescriptors, getCurrentTimeZoneId, getCurrentEpochNano, getCurrentIsoDateTime } from "./internal.js";

import { createDateTimeFormatClass, createIntlExtended } from "./classApi.js";

import { defineTemporalClass, dateDerivedGetters, dateFieldGetters, withZonedDateTimeFields, diffZonedDateTimes, forbiddenValueOf, ZonedDateTimeBranding, invalidRecordType, attachDebugString, diffInstants, InstantBranding, monthDayFieldGetters, withMonthDayFields, PlainMonthDayBranding, yearMonthDerivedGetters, yearMonthFieldGetters, withYearMonthFields, diffYearMonths, PlainYearMonthBranding, PlainDateTimeBranding, PlainDateBranding, PlainTimeBranding, DurationBranding, withTimeFields, diffTimes, withDateTimeFields, diffDateTimes, withDateFields, diffDates } from "./apiHelpers.js";

import "temporal-utils/protected-error-messages";

import { toIntegerWithTrunc } from "temporal-utils/protected";

import { getExoticCalendarById } from "./exoticCalendars.js";

import { refineOverflowOptions, refineRoundingOptions, refineDirectionOptions, refineZonedFieldOptions, refineEpochDisambigOptions } from "./options.js";

function resolveAnyCalendarId(rawCalendarId) {
  const lowerRawCalendarId = requireString(rawCalendarId).toLowerCase();
  return lowerRawCalendarId === isoCalendarId ? isoCalendarImpl : lowerRawCalendarId === gregoryCalendarId ? gregoryCalendarImpl : getExoticCalendarById(lowerRawCalendarId);
}
...
}, getZonedDateTimeIsoSlots, dateFieldGetters, dateDerivedGetters, timeGetters);
...
}, getPlainMonthDaySlots, monthDayFieldGetters);
...
}, getPlainYearMonthSlots, yearMonthFieldGetters, yearMonthDerivedGetters);
...
}, getPlainDateTimeSlots, dateFieldGetters, dateDerivedGetters, timeGetters);
...
}, getPlainDateSlots, dateFieldGetters, dateDerivedGetters);
...
const IntlExtended = /*@__PURE__*/ createIntlExtended(DateTimeFormat);

export { DateTimeFormat, IntlExtended, Temporal, toTemporalInstant };
